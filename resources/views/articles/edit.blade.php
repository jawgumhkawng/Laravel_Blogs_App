    ...
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class=" form-group mb-4">
                ...
                <img src="{{ url('./images/' . $articles->image) }}" width="300px" height="270px"
                    style="border-radius: 10px; border:1px solid gray" alt=""><br><br>

                <div class="custom-file">
                    <input type="file" class="form-control " name="image" placeholder="choose image"
                        value="{{ old('$article->image', $articles->image) }}"
                        id="customFile"{{ $articles->image ? $articles->image : 'required' }}>
                </div>
            </div>
